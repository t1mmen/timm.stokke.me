...
That's exactly where I found myself while building [Timely](https://timely.com)'s next-generation Memory Engine. Here we were in 2023, with hot-reloading everything on the frontend, yet still copy-pasting SQL into database consoles like it was 1999.
